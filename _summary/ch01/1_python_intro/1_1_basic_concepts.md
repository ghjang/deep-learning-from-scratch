...
* __파이썬은 동적 타이핑 언어지만 타입 힌트를 지원한다.__

  파이썬의 타입 시스템의 특성:
  
  1. __동적 타이핑__: 변수에 타입을 선언하지 않고 사용
  ...
  2. __강력한 타입 시스템__: 타입 변환은 명시적으로 수행됨
  ...
  3. __타입 힌트__: 실행 시점에 강제되지 않는 타입 정보
...
## 1.1.4 파이썬 변수와 메모리 관리

* __파이썬의 변수는 객체의 참조이다.__
...
* __함수 인자는 객체 참조로 전달된다.__ (Call by Object Reference)
...
* __가비지 컬렉션과 참조 카운팅으로 메모리를 관리한다.__
